...
NRS.onSiteBuildDone().then(() => {
    NRS = (function(NRS, $, undefined) {
        ...
        $('#voucher_json').change(function() {
            ...
            let details = NRS.buildDataFromTransactionJSON(voucher.requestType, transactionJSON);
            ...
            if (result.fail) {
                msg = $.t("cannot_verify_voucher_content", {
                    param: result.param,
                    expected: result.expected,
                    expectedType: typeof(result.expected),
