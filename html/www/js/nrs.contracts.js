    ...
    NRS = (function(NRS) {
        ...
        NRS.jsondata.contracts = function(contract, account) {
            ...
            return {
                ...
                accountFormatted: NRS.getTransactionLink(contract.uploadTransaction.fullHash, contract.uploadTransaction.senderRS, false, contract.uploadTransaction.chain),
