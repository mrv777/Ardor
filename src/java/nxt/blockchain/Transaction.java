...
public interface Transaction extends AccountLedger.LedgerEventId {
    ...
    interface Builder {
        ...
        Transaction build(byte[] privateKey) throws NxtException.NotValidException;

        Transaction build(byte[] privateKey, boolean isVoucher) throws NxtException.NotValidException;
