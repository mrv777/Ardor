...
public class BundlingEncryptedConfig extends AbstractEncryptedConfig {
    @Override
    ...
    protected JSONStreamAware processDecrypted(BufferedReader reader) throws ParseException, IOException {
        JSONArray bundlers = StartBundling.startBundlers((JSONObject) JSONValue.parseWithException(reader));
        JSONObject response = new JSONObject();
        response.put("bundlers", bundlers);
        return response;
    }
}
