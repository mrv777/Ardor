...
/**
 * Returns the phasing control for given account, if set. The result contains the following entries similar to the control* parameters of {@link SetPhasingOnlyControl}
 * 
 * <ul>
